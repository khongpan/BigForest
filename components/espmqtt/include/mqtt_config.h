...
#ifdef CONFIG_MQTT_LOG_ERROR_ON
#define mqtt_error(format, ... ) ESP_LOGE( MQTT_TAG , format, ##__VA_ARGS__)
#else
#define mqtt_error( format, ... )
#endif
#ifdef CONFIG_MQTT_LOG_WARN_ON
#define mqtt_warn(format, ... )  ESP_LOGW( MQTT_TAG , format, ##__VA_ARGS__)
#else
#define mqtt_warn( format, ... )
#endif
#ifdef CONFIG_MQTT_LOG_INFO_ON
#define mqtt_info(format, ... )  ESP_LOGV( MQTT_TAG , format, ##__VA_ARGS__)
#else
#define mqtt_info(format, ... )
#endif
